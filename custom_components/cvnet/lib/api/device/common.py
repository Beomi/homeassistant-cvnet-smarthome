...
from ...model.device import (
    EnabledDevicesRespond,
    DeviceType,
    DeviceDetailAndConnectInformation,
)
...
class DeviceApi:
    @staticmethod
    async def get_enabled_devices(
        websession: aiohttp.ClientSession, config: CvnetConfig
    ) -> EnabledDevicesRespond:
        response = await websession.post(
            f"https://{config.host}/cvnet/mobile/mainmenu_info.do",
            data="[object Object]",
            headers={
    ...
    async def get_device_detail(
        websession: aiohttp.ClientSession, config: CvnetConfig, device_type: DeviceType
    ) -> DeviceDetailAndConnectInformation:
        ...
        response = await websession.post(
            f"https://{config.host}/cvnet/mobile/device_info.do",
